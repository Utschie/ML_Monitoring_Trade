#本模型把抽取的节点从250改到500,看看情况，初始学习率采用0.001，优化器用adam
#不能加到1000,加到1000显存会爆
#节点从250加到500后对预测结果也并没有很显著的提高，loss下降的几乎也可忽略不计————20210201
#这说明问题应该还是出在模型最前面的数据预处理上对信息的提取上面或者模型结构上面————20210201
import os
import torch
...
if __name__ == "__main__":
    train_writer = SummaryWriter('/home/jsy/log4/train')#自动建立
    test_writer = SummaryWriter('/home/jsy/log4/test')#自动建立
    checkpoint_path = '/home/jsy/log4/checkpoint.pth'#ckpoint文件夹需要提前建立
