...
if __name__ == "__main__":
    summary_writer = tf.summary.create_file_writer('./tensorboard_1.0_middle_PPO') #在代码所在文件夹同目录下创建tensorboard文件夹（本代码在jupyternotbook里跑，所以在jupyternotebook里可以看到）
    summary_writer2 = tf.summary.create_file_writer('./tensorboard_1.0_middle_PPO/use_out_time')
    summary_writer3 = tf.summary.create_file_writer('./tensorboard_1.0_middle_PPO/max_frametime')
    summary_writer4 = tf.summary.create_file_writer('./tensorboard_1.0_middle_PPO/used_steps')
