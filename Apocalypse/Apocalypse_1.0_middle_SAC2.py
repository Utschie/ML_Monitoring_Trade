...
#本模型是永远保留随机挑选行动时间点，然后在行动时间点内进行随机或贪心交易————20201020
import os
...
if __name__ == "__main__":
    summary_writer = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2')
    summary_writer2 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/use_out_time')
    summary_writer3 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/max_frametime')
    summary_writer4 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/used_steps')
    summary_writer5 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/bisai_steps')
    summary_writer6 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/actor_loss')
    summary_writer7 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/critic_loss')
    summary_writer8 = tf.summary.create_file_writer('./tensorboard_1.0_middle_SAC2/mini_critic_loss')
    start0 = time.time()
    epsilon = 1.            # 探索起始时的探索率
    ...
    bisai_counter = 1
    N_random_points = 134
    critic_weights_path = 'D:\\data\\critic_Q_weights_1.0_middle_SAC2.ckpt'
    actor_weights_path = 'D:\\data\\actor_weights_1.0_middle_SAC2.ckpt'
