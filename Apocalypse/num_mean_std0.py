...
train_path = ['/media/jsy/Samsung/train_20160701-20170531']
filepath=train_path
...
old_var = new_var#用新的var代替旧的var
old_n = new_n#用新的n代替旧的n
np.save('/home/jsy/data/num_old_mean0.npy',old_mean)
np.save('/home/jsy/data/num_old_var0.npy',old_var)
np.save('/home/jsy/data/num_old_n0.npy',old_n)
print(old_n)
print(old_mean)
print(old_var)
del framematrix
